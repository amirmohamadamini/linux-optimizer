...
#### Then:
```
wget "https://raw.githubusercontent.com/amirmohamadamini/linux-optimizer/refs/heads/main/linux-optimizer.sh" -O linux-optimizer.sh && chmod +x linux-optimizer.sh && bash linux-optimizer.sh 
```
