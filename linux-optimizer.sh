...
ubuntu)
    # Ubuntu
    wget "https://raw.githubusercontent.com/amirmohamadamini/linux-optimizer/refs/heads/main/scripts/ubuntu-optimizer.sh" -q -O ubuntu-optimizer.sh && chmod +x ubuntu-optimizer.sh && bash ubuntu-optimizer.sh 
    ;;
debian)
    # Debian
